...
contract("LITTVestingContract tests", async(accounts) => {
    ...
    it("3. Users should withdraw rewards but user 7 that should fail", async () => {
        let oneMonthLater = Math.round((new Date().getTime() / 1000) + (4 * 30 * 24 * 3600));
    ...
    it("3. Should simulate the vesting a tournament", async () => {
        let startTime = Math.round((new Date().getTime() / 1000) + (6 * 30 * 24 * 3600));
