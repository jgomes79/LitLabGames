...
async function doDeploy(deployer, network, accounts) {
    ...
    let token = await LitlabGamesToken.at('0xcebef3df1f3c5bfd90fde603e71f31a53b11944d');
...
*/
    ...
    const manager = '0x8889a07d24CB404c205c229E65233be21820c88D';
    const feeWallet = '0x085ea4C4B5B856691d8Bc70bDcd7cD5854dcD78F';
    const maxBet = web3.utils.toWei('1000000');

    await deployer.deploy(CyberTitansGame, forwarder.address, manager, feeWallet, token.address, maxBet);
    let cyberTitansGame = await CyberTitansGame.deployed();
    console.log('CyberTitansGame deployed:', cyberTitansGame.address);

    //await cyberTitansGame.changeWinnersPercentages([600, 350], 25, 25);
